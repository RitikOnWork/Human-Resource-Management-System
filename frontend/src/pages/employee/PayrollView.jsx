...
const PayrollView = () => {
    ...
    return (
        <div className="payroll-view-container">
            <h2 className="page-title" style={{ marginBottom: '1rem' }}>Enterprise Payroll Engine</h2>
            <p className="portal-subtitle" style={{ color: '#94a3b8', marginBottom: '2rem' }}>
                Powered by Java HotSpot™ High-Precision Compute
            </p>

            <div className="leave-content-layout" style={{ gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
                {/* Input Card */}
                <div className="leave-form-card">
                    <h3 style={{ borderBottom: '1px solid rgba(255,255,255,0.05)', paddingBottom: '1rem', display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    <form onSubmit={calculatePayroll}>
                        <div className="form-group">
                            <label className="required-label">Base Salary (₹)</label>
                            <input 
                                type="number" 
                ...
                <div className="leave-history-card">
                    ...
                    {loading && (
                        <div className="no-data" style={{ color: '#a78bfa' }}>
                    ...
                    {result && (
                        <div className="payroll-results" style={{ animation: 'fadeIn 0.5s ease' }}>
                            <div className="detail-row" style={{ display: 'flex', justifyContent: 'space-between', padding: '15px 0', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                            ...
                            <div className="net-salary-box" style={{ marginTop: '20px', background: 'linear-gradient(135deg, rgba(167,139,250,0.1), rgba(99,102,241,0.1))', padding: '20px', borderRadius: '12px', border: '1px solid rgba(167,139,250,0.3)', textAlign: 'center' }}>
